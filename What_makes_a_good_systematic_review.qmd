...
Ensure that the conclusions drawn in the review are supported by the evidence presented. Look for consistency between the review findings and the data synthesised from the included studies. Do not just rely on the abstract or the lay summary.
